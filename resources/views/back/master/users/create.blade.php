...
@section('content')
    <h4 class="fw-bold"><span class="text-muted fw-light">Master / Users / </span> Tambah</h4>
                ...
                <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nik" id="nik" class="form-control @error('nik') is-invalid @enderror" placeholder="Masukkan nomor induk karyawan" value="{{old('nik')}}">
                                    @error('nik')
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Masukkan nama lengkap" value="{{old('name')}}">
                                    @error('name')
                                        <div class="invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-6">
                                ...
                                <input type="file" name="signature" id="signature" class="dropify" data-allowed-file-extensions="jpg jpeg png webp" data-max-file-size-preview="3M">
                            </div>
                            <div class="col-lg-6">
                                <label for="avatar" class="form-label">Photo Profile<span class="text-danger">*</span></label>
                                <input type="file" name="avatar" id="avatar" class="dropify" data-allowed-file-extensions="jpg jpeg png webp" data-max-file-size-preview="3M">
                            </div>
                        </div>
                </div>
            </div>
