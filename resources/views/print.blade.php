...
<div class="container">
    <div class="row my-3">
        <div class="col-lg-12">
            <table class="table table-bordered border-dark table-sm">
                <tr>
                    <td rowspan="3" colspan="2" class="align-middle">
                        <img src="{{public_path('images/header-kalbe.png')}}" width="200">
                    </td>
                    <td rowspan="2" class="text-center fw-bold align-middle"><h5>Form</h5></td>
                    <td>No Dok</td>
                    <td colspan="2">: FR/IOS-SYS/CMT/020</td>
                </tr>
                <tr>
                    <td>No Rev</td>
                    <td colspan="2">: 05</td>
                ...
                <tr>
                    <td rowspan="2" class="text-center fw-bold align-middle"><h5>Change Management Form</h5></td>
                    <td>Tgl Berlaku</td>
                    <td colspan="2">: 1 Oktober 2019</td>
                </tr>
                <tr>
                    <td colspan="2" class="text-center">PT Kalbe Morinaga Indonesia</td>
                    <td>Halaman</td>
                    <td colspan="2">: 1 dari 1</td>
                </tr>
                <tr>
                    <td colspan="2">Departemen <sup>1)</sup> : {{$cmf->user->department->txtNamaDept}}</td>
                    <td>Tanggal <sup>1)</sup> : {{$cmf->created_at->format('d M Y')}}</td>
                    <td colspan="3">Nomor <sup>2)</sup> : {{$cmf->no_cmf}}</td>
                </tr>
                <tr>
                    <td colspan="6">Judul Perubahan <sup>1)</sup> : {{$cmf->judul_perubahan}}</td>
                </tr>
                <tr>
                    <td colspan="6">Perubahan <sup>1)</sup> :
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="Mesin" {{$cmf->perubahan == "Mesin" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox1">Mesin</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="Proses" {{$cmf->perubahan == "Proses" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox2">Proses</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="System" {{$cmf->perubahan == "System" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox3">System</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox4" value="Lainnya" {{$cmf->perubahan == "Lainnya" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox4">Lainnya</label>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="6">Jenis <sup>* 1)</sup> :
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="Instalasi" {{$cmf->jenis_perubahan == "Instalasi" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox1">Instalasi</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="Formula" {{$cmf->jenis_perubahan == "Formula" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox2">Formula</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="Raw Material" {{$cmf->jenis_perubahan == "Raw Material" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox3">Raw Material</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox4" value="Packaging Material" {{$cmf->jenis_perubahan == "Packaging Material" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox4">Packaging Material</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="Spesifikasi Produk" {{$cmf->jenis_perubahan == "Spesifikasi Produk" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox3">Spesifikasi Produk</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox4" value="Food Safety Management" {{$cmf->jenis_perubahan == "Food Safety Management" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox4">Food Safety Management</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="Oracle" {{$cmf->jenis_perubahan == "Oracle" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox3">Oracle</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox4" value="SMK3" {{$cmf->jenis_perubahan == "SMK3" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox4">SMK3</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="Halal Management" {{$cmf->jenis_perubahan == "Halal Management" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox3">Halal Management</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox4" value="Lainnya" {{$cmf->jenis_perubahan == "Lainnya" ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox4">Lainnya</label>
                        </div>
                        <br>
                        <small>(*) Pilih salah satu. Jika perubahan berdampak ke yang lain, bisa pilih lebih dari 1</small>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" class="text-center">Target Implementasi (tanggal): {{date('d M Y', strtotime($cmf->target_implementasi))}}</td>
                    <td colspan="3" class="text-center">Type Perubahan <br>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="Temporary" {{$cmf->tipe_perubahan == 'Temporary' ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox3">Temporary</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox4" value="Permanent" {{$cmf->tipe_perubahan == 'Permanent' ? 'checked' : ''}}>
                            <label class="form-check-label" for="inlineCheckbox4">Permanent</label>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="6">
                        Alasan perubahan <sup>1)</sup> (Latar belakang & Tujuan): <br>
                        {{$cmf->alasan_perubahan}}
                        <br>
                        <br>
                    </td>
                </tr>
                <tr>
                    <td colspan="6">
                        Dampak terhadap perubahan <sup>1)</sup>  (Quality, biaya, food safety, keselamatan & kesehatan lingkungan atau regulasi) : <br>
                        {{$cmf->dampak_terhadap_perubahan}}
                        <br>
                        <br>
                    </td>
                </tr>
                <tr>
                    <td colspan="6">
                        Deskripsi perubahan <sup>1)</sup>   (keterangan perubahan produk) : <br>
                        {{$cmf->deskripsi_perubahan}}
                        <br>
                        <br>
                    </td>
                </tr>
                <tr>
                    <td colspan="6" class="text-center">Risk Assesment:</td>
                </tr>
                <tr>
                    <td>No</td>
                    <td>Resiko</td>
                    <td>Rencana Mitigasi</td>
                    <td>PIC</td>
                    <td>Deadline</td>
                    <td></td>
                </tr>
                @foreach($cmf->risks as $risk)
                    <tr>
                        ...
                        <td>{{$risk->pic}}</td>
                        <td>{{date('d M Y', strtotime($risk->deadline))}}</td>
                        <td>{{$risk->status}}</td>
                    </tr>
                @endforeach
                ...
                <tr>
                    ...
                    <td class="text-center" colspan="4">Catatan Depthead</td>
                    <td class="text-center">Disetujui Oleh</td>
                </tr>
                <tr>
                    <td>{{$cmf->user->name}}</td>
                    <td  colspan="4" rowspan="2">{{$check_signature_step_1->catatan ?? 'Tidak ada catatan'}}</td>
                    <td class="align-middle">
                        <div class="text-center">
                            <img src="{{public_path('storage/uploads/signature/'.$check_signature_step_1->user->signature)}}" width="80">
                        </div>
                    </td>
                </tr>
                <tr>
                    <td class="text-center">Pemilik Proses</td>
                    <td class="text-center">Dept Head</td>
                </tr>
                <tr>
                    <td colspan="6">Area Terkait: <sup>1&2)</sup>
                        @foreach($check_signature_step_2 as $step2)
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="{{$step2->id}}" {{$step2->is_signature == 1 ? 'checked' : ''}}>
                                <label class="form-check-label" for="{{$step2->id}}">{{$step2->user->department->txtNamaDept}}</label>
                            </div>
                        @endforeach
                        <br>
                        *isi dengan nama departemen vanq terkait dan membutuhkan informasi terkait

                    </td>
                </tr>
                @foreach($signature_reviews as $review)
                    <tr>
                        <td colspan="5">Review Dari Departemen Lain <sup>3)</sup>:
                            <br>
                            <div class="d-flex justify-content-between">
                                <p>{{$review->review->review}}</p>
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox4" {{$review->is_signature == 1 ? 'checked' : ''}}>
                                        <label class="form-check-label" for="inlineCheckbox4">Setuju</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox4" {{$review->is_signature == 0 ? 'checked' : ''}}>
                                        <label class="form-check-label" for="inlineCheckbox4">Tidak Setuju</label>
                                    </div>
                                </div>
                            </div>
                        </td>
                        <td>
                            Paraf Dept Head
                            <img src="{{public_path('storage/uploads/signature/'.$review->user->signature)}}" width="80">
                        </td>
                    </tr>
                @endforeach
                <tr>
                    <td colspan="6" class="text-center">Mengetahui</td>
                </tr>
                <tr>
                    <td colspan="2" class="align-middle">
                        <div class="text-center">
                            <img src="{{public_path('storage/uploads/signature/'.$check_signature_step_3->user->signature)}}" width="80">
                        </div>
                    </td>
                    <td colspan="2" class="align-middle">
                        <div class="text-center">
                            <img src="{{public_path('storage/uploads/signature/'.$check_signature_step_5->user->signature)}}" width="80">
                        </div>
                    </td>
                    <td colspan="2" class="align-middle">
                        <div class="text-center">
                            <img src="{{public_path('storage/uploads/signature/'.$check_signature_step_4->user->signature)}}" width="80">
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" class="text-center">System</td>
                    <td colspan="2" class="text-center">MR</td>
                    <td colspan="2" class="text-center">Manufacturing Head</td>
                </tr>
                <tr>
                    <td colspan="6">Review setelah dilakukan perubahan:</td>
                </tr>
                <tr>
                    <td colspan="6">
                        Detail aktifitas <sup>1)</sup> : (tanggal instalasi, tanggal trial, tanggal implementasi)
                        <br>
                        Tanggal Instalasi : {{date('d M Y', strtotime($cmf->activity->tanggal_instalasi))}}
                        <br>
                        Tanggal Trial : {{date('d M Y', strtotime($cmf->activity->tanggal_trial))}}
                        <br>
                        Tanggal Implementasi : {{date('d M Y', strtotime($cmf->activity->tanggal_implementasi))}}
                    </td>
                </tr>
                <tr>
                    <td class="text-center">Dibuat oleh</td>
                ...
                <tr>
                    <td class="text-center">{{$cmf->user->name}}</td>
                    <td  colspan="4" rowspan="2">{{$check_signature_step_6->catatan ?? 'Tidak ada catatan'}}</td>
                    <td class="align-middle">
                        <div class="text-center">
                            <img src="{{public_path('storage/uploads/signature/'.$check_signature_step_6->user->signature)}}" width="80">
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                @foreach($signature_evaluations as $evaluation)
                    <tr>
                        <td colspan="5">Evaluasi & Verifikasi Dari Departemen Lain <sup>3)</sup>:
                            <br>
                            <div class="d-flex justify-content-between">
                                <p>{{$evaluation->evaluation->evaluasi}}</p>
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox4" {{$evaluation->is_signature == 1 ? 'checked' : ''}}>
                                        <label class="form-check-label" for="inlineCheckbox4">Setuju</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox4" {{$evaluation->is_signature == 0 ? 'checked' : ''}}>
                                        <label class="form-check-label" for="inlineCheckbox4">Tidak Setuju</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <td>
                            Paraf Dept Head
                            <div class="text-center">
                                <img src="{{public_path('storage/uploads/signature/'.$evaluation->user->signature)}}" width="80">
                            </div>
                        </td>
                    </tr>
                @endforeach
                ...
                <tr>
                    ...
                    <td class="text-center">Post Dokumen</td>
                    <td class="text-center">Applicable</td>
                    <td class="text-center">Not Applicable</td>
                    <td colspan="2" class="text-center">Verifikasi</td>
                </tr>
                <tr>
                    ...
                    <td class="text-center"></td>
                    <td colspan="2" rowspan="4" class="text-center align-middle">
                        <div class="text-center">
                            <img src="{{public_path('storage/uploads/signature/'.$check_signature_step_8->user->signature)}}" width="80">
                        </div>
                    </td>
                </tr>
                <tr>
                    <td class="text-center">2</td>
                    <td class="text-center">Flowchart</td>
                    <td class="text-center"></td>
                    <td class="text-center"></td>
                </tr>
                <tr>
                    <td class="text-center">3</td>
                    <td class="text-center">HACCP</td>
                    <td class="text-center"></td>
                    <td class="text-center"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="text-center">Instruksi Kerja</td>
                    <td class="text-center"></td>
                    <td class="text-center"></td>
                    <td colspan="2" class="text-center">Food & Safety Team</td>
                </tr>
                <tr>
                    <td class="text-center">6</td>
                    <td class="text-center">Ketentuan</td>
                    <td class="text-center"></td>
                    <td class="text-center"></td>
                    <td colspan="2" rowspan="4" class="text-center align-middle">
                        <div class="text-center">
                            <img src="{{public_path('storage/uploads/signature/'.$check_signature_step_9->user->signature)}}" width="80">
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="text-center"></td>
                    <td class="text-center"></td>
                    <td colspan="2" class="text-center">Document Control</td>
                </tr>
                <tr>
                    <td colspan="6"></td>
                </tr>
                <tr>
                    <td colspan="3" rowspan="3">STATUS: CANCEL/CLOSED</td>
                    <td colspan="3" class="text-center">Mengetahui</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" class="text-center">MR</td>
                </tr>
            </table>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-lg-12">
            Keterangan:
            <ol type="1">
                <li>) Diisi oleh departemen pemilik proses / area yang berubah</li>
                <li>) Diisi Oleh System</li>
                <li>) Diisi sesuai departemen terkait (QAC, PRD, WHS, ENG, FA/IT, HRD atau IOS) - Jumlah baris akan bertambah sesuai dengan jumlah departemen yang me-review. Akan dikumpulkan oleh DC (by email)</li>
                <li>) Jika ada salah satu review dari departemen lain yang "tidak setuju", maka perubahan dapat dibatalkan / tidak dilanjutkan</li>
            </ol>
            <strong>Controlled Copy</strong>
        </div>
    </div>
</div>
</body>
